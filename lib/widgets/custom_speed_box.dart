...
class _CustomSpeedBoxState extends State<CustomSpeedBox> {
  ...
  Widget build(BuildContext context) {
    if (int.parse(widget.speedvalue) <= 120 && !_showDialog) {
      NotificationService().showNotification(
          body: "Please, slow down  because you are nervous.",
          title: "High Speed !!",
          id: 3);
      // Show the dialog only if the battery percentage is 20% and the dialog is not already shown
      _showDialog =
          true; // Update the state to prevent showing the dialog multiple times
