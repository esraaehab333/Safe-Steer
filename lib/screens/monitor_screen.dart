...
import '../widgets/custom_battary_box.dart';
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: MyElevatedButton(
                                                onPressed: () {
                                                  databaseReference.child(widget.keyId).remove();
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                MyElevatedButton(
                                                  ...
                                                  width: 80,
                                                  gradient: LinearGradient(
                                                      colors: [MyBlueGradiant5,MyBlueGradiant5], end:Alignment.bottomCenter , begin: Alignment.topCenter),
                                                  borderRadius:
                                                      BorderRadius.circular(15),
                                                  child: Text(
                                                    "save",
                                                ...
                                                MyElevatedButton(
                                                  ...
                                                  width: 80,
                                                  gradient: LinearGradient(
                                                      colors: [MyBlueGradiant6,MyBlueGradiant6], end:Alignment.bottomCenter , begin: Alignment.topCenter),
                                                  borderRadius:
                                                  BorderRadius.circular(15),
                                                  child: Text(
                                                    "cancel",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                CustomSpeedBox(speedvalue: data["Speed"] , speedlimit: data["SpeedLimit"]),
                                SizedBox(
                                  height:
                                      MediaQuery.of(context).size.height * 0.0177,
                                ),
